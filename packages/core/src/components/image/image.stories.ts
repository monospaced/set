...
const meta = {
  argTypes: {
    ...
    stillSrc: { ...baseArgTypes.stillSrc, control: false },
  },
  parameters: {
    docs: {
      description: {
...
export const Default = {
  args: {
    ...
    lazy: false,
    priority: false,
    src: "https://res.cloudinary.com/monospaced/image/upload/v1789385882/2018-04-20_15.28.26--cyan--640--mid.png",
    srcSet: [
      "https://res.cloudinary.com/monospaced/image/upload/v1789385882/2018-04-20_15.28.26--cyan--640--mid.png 640w",
      "https://res.cloudinary.com/monospaced/image/upload/v1789250805/2018-04-20_15.28.26--cyan--mid.png 1280w",
      "https://res.cloudinary.com/monospaced/image/upload/v1789385882/2018-04-20_15.28.26--cyan--2560--mid.png 2560w",
    ].join(", "),
 ...
 * the load-scan intro that plays once then reveals it, `stillSrc` the
...
const animatedSource = (
  ...
  stillSrc: `${ANIMATED}--${aspect}--adaptive.svg`,
  width,
});
...
export const SequencedAnimatedAdaptiveArtDirection = {
  args: {
    ...
    stillSrc: `${ANIMATED}--4x5--640--adaptive.svg`,
  } satisfies SetImageProps,
  render: (args: SetImageProps) => renderSetImage(args),
};
...
export const SimpleAnimated = {
  args: {
    ...
    stillSrc:
      "https://res.cloudinary.com/monospaced/image/upload/v1789385882/2018-04-20_15.28.26--cyan--640--mid.png",
    width: 640,
  } satisfies SetImageProps,
  render: (args: SetImageProps) => renderSetImage(args),
};
