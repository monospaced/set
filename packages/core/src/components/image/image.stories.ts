...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: `${specToComponentDescription(SET_IMAGE_SPEC)}\n\nStory imagery carries Set's branded image treatment — a dark, two-level ordered-dither bitmap on a brand palette axis — processed with [Screen](https://screen.monospaced.com).`,
      },
    },
  },
  title: "Graphic/Image",
